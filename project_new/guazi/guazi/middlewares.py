...
class GuaziProxyMiddleware(object):
    def __init__(self):
        self.count = 0
    ...
    def process_request(self, request, spider):
        if spider.name in ['guazi_car', 'guazi_guzhi', 'jzg_40city', 'che300_price_daily_sh_city',
...
class GuaziUserAgentMiddleware(UserAgentMiddleware):
    def process_request(self, request, spider):
