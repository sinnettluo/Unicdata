...
import pymysql
import pandas as pd
# from .items import Che168MissSpider Item
def readMysqls(sql):
...
class Che168MissSpider(scrapy.Spider):
    name = 'che168_miss'
    ...
    def __init__(self, **kwargs):
        super(Che168MissSpider, self).__init__(**kwargs)
        self.counts = 0
    ...
    custom_debug_settings = {
        ...
        'MYSQL_TABLE': 'che168_miss',
        'MONGODB_SERVER': '192.168.1.94',
        'MONGODB_DB': 'usedcar_update',
        'MONGODB_COLLECTION': 'che168_miss',
