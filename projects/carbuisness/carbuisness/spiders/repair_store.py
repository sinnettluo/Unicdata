    ...
    def start_requests(self):
        ...
        for city_name in cols_city_name:
            for i in range(page_num):
                url = "http://api.map.baidu.com/place/v2/search?query=一汽特许维修门店&region=%s&page_num=%d&output=json&ak=0nIp0ZxAyuSbIloGzSqZMK006GALOZMo" % (city_name, i)
