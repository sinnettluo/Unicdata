...
"""
import scrapy
from koubei.items import GongxinbuWJGSItem
import time
        ...
        if response.url.find("index.html") >= 0:
            ...
            if page_num > 1:
                for i in range(2, page_num + 1):
                    next_url = "http://www.miit.gov.cn/n1146295/n1652858/n1653100/index_5143853_%d.html" % (i - 1)
