...
class CarSpider(scrapy.Spider):
    ...
    def parse_level2(self, response):
        ...
        res = requests.request(method="get", url='http://data.stats.gov.cn/easyquery.htm?m=QueryData&dbcode=hgyd&rowcode=zb&colcode=sj&wds=[]&dfwds=[{"wdcode":"sj","valuecode":"LAST36"}]')
        ...
        for level2 in level2s:
            ...
            if level2["isParent"]:
                ...
                url = "http://data.stats.gov.cn/easyquery.htm?m=QueryData&dbcode=hgyd&rowcode=zb&colcode=sj&wds=[]&dfwds=%s" % qstr
